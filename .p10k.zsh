# Generated by Powerlevel10k configuration wizard on 2024-10-17 at 10:12 MSK.
...
# light-ornaments, sparse, many icons, concise, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%188F╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%000F├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%188F╰─'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='󰛓'
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=#D399E6
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=109
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=109
